angular.module('test-angular').run(['$templateCache', function($templateCache) {
  'use strict';
  ...
  $templateCache.put('app/modules/rest/rest.html',
    "<div class=\"md-padding\" flex layout-sm=\"column\">\n" +
    "    <md-card>\n" +
    "        <md-card-content>\n" +
    ...
    "                <button class=\"button-refresh\" ng-click=\"vm.fetchPullRequests()\">Refresh</button>\n" +
    "            </p>\n" +
    "\n" +
